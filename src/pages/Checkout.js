                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      ...
                      <input
                        ...
                        {...register("phone", {
                          ...
                          pattern: {
                            value: /^[6789]\d{9}$/,
                            message:
                              "Please Enter A valid Indian 10 Digit number  ",
                          },
                        })}
                        // type="tel"
                        className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                  ...
                  <div className="col-span-full">
                    <label
                      ...
                      className="block text-sm font-medium leading-6 text-gray-900"
                    >
                      Nearby You Famous Place / Shop / School
                    </label>
                    <div className="mt-2">
                      <input
                        id="nearbyPlace"
                        {...register("nearbyPlace", {
                          required: "nearbyPlace is required",
                        })}
                        type="tel"
                        className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                      />
                    ...
                    <div className="mt-2">
                      <textarea
                        ...
                        {...register("fullAddress", {
                          required: "Full adress is required",
                        })}
                        id="fullAddress"
                        rows={5}
                        className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-1 sm:px-1 lg:px-4">
              <div className="border-t border-gray-200 px-1 py-1 sm:px-1">
                ...
                <div className="flow-root">
                  <ul
                    role="list"
                    className="-my-6 divide-y py-1 divide-gray-200"
                  >
                    {cartProducts &&
              ...
              <div className="border-t border-gray-200 px-1 py-1 sm:px-4">
