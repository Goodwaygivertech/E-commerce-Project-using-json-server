...
function ProductForm() {
  ...
  const handleAdd = () => {
    ...
    saveProductBtn.innerText = "Poduct Added";
  };

  const handleCancelClick = () => {
    // Use the history.replace method to navigate to "/" and replace the current history entry
    reset()
    return(
      <Navigate to={"/"} replace={true}></Navigate>
    )
    // Call the reset() function here if needed
  };
  return (
    <form
      noValidate
